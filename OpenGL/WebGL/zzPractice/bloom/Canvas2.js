...
var grgPerspectiveMatrix;
var tex_src;
var grgVertexShaderObject1;
var grgFragmentShadeerObject1;
var grgVertexShaderObject2;
var grgFragmentShadeerObject2;
var grgVertexShaderObject3;
var grgFragmentShadeerObject3;

var render_fbo;
 grgColorBlack = vec3(0.0, 0.0, 0.0);
var grgOne = 1.0;
var tex_scene;
...
function init()
{
    ...
    grgPerspectiveMatrix = mat4.create();
    // blue color
...
function resize()
{
    ...
    mat4.perspective(grgPerspectiveMatrix, 45.0, parseFloat(canvas.width) / parseFloat(canvas.height), 0.1, 100.0);
