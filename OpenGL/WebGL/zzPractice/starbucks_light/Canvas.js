...
function keyDown(event)
{
   switch(event.keyCode)
   {
       case 70 :
        ...
        case 88 :                   // x key
            grfangleCameraX = grfangleCameraX + 1.0;
            if(grfangleCameraX >= 360.0)
            {
                grfangleCameraX = 0.0;
            }
            break;
        ...
        case 89 :                               // y key
            grfangleCameraY = grfangleCameraY + 1.0;
            if(grfangleCameraY >= 360.0)
            {
                grfangleCameraY = 0.0;
            }
            break;
        ...
        case 38 : // up arrow
            grtransCameraY = grtransCameraY + 0.2;
            break;
