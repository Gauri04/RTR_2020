			...
			switch(event.type)
				...
				case KeyPress:
					...
					switch(keysym)
					{
						...
						case XK_0 :
							//printf("\n left : 0, top : %f, right : %f, bottom : %f", (float)(winHeight / 2), (float)(winWidth /2), (float)(winHeight / 2));
							glViewport(0, 0, (GLsizei)winWidth, (GLsizei)winHeight);
							break;

						case XK_1 :
							glViewport(GLsizei(0), (GLsizei(winHeight / 2)), (GLsizei(winWidth /2)), (GLsizei(winHeight / 2)));
							break;
