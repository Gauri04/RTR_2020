...
void CreateWindow()
{
	...
	for(i = 0; i < 5; i++)
	{
		...
		if(pTempXVisualInfo != NULL)
		{
			...
			printf("\n i : %d", i);
			printf("\n samples : %d", samples);
			printf("\n sampleBuffers : %d", sampleBuffers);
			glXGetFBConfigAttrib(gpDisplay, pglxFBConfig[i], GLX_SAMPLE_BUFFERS, &sampleBuffers);
			glXGetFBConfigAttrib(gpDisplay, pglxFBConfig[i], GLX_SAMPLES, &samples);
			printf("\n After function call : i : %d", i);
			printf("\n samples : %d", samples);
			printf("\n sampleBuffers : %d", sampleBuffers);
			printf("\n When i = %d, samples = %d, sampleBuffers", i, samples);
			printf("\n When i = %d, samples = %d, sampleBuffers", i, samples);
			printf("\n When i = %d, samples = %d, sampleBuffers", i, samples);
			//printf("\n When i = %d, samples = %d, sampleBuffers = %d, tempXVisualId = %lu", i, samples, sampleBuffers, pTempXVisualInfo->visualid);
