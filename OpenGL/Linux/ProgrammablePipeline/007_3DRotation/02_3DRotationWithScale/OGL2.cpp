...
GLuint grgVboColorPyramid;
GLuint grgVboPositionCube;
GLuint grgVboColorCube;
...
void Initialize()
{
	...
	// color
	glGenBuffers(1, &grgVboColorPyramid);
	glBindBuffer(GL_ARRAY_BUFFER, grgVboColorPyramid);
	...
	// color
	glGenBuffers(1, &grgVboColorCube);
	glBindBuffer(GL_ARRAY_BUFFER, grgVboColorCube);
...
void Uninitialize()
{
	...
	if (grgVboColorPyramid)
	{
		glDeleteBuffers(1, &grgVboColorPyramid);
		grgVboColorPyramid = 0;
	}
	...
	if (grgVboColorCube)
	{
		glDeleteBuffers(1, &grgVboColorCube);
		grgVboColorCube = 0;
	}
