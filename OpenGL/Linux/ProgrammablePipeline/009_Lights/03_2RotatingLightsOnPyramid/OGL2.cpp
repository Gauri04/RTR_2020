...
GLuint grgVboPyramidPosition;
GLuint grgVboPyramidNormal;
...
void Initialize()
{
	...
	// position
	glGenBuffers(1, &grgVboPyramidPosition);
	glBindBuffer(GL_ARRAY_BUFFER, grgVboPyramidPosition);
	...
	// normals
	glGenBuffers(1, &grgVboPyramidNormal);
	glBindBuffer(GL_ARRAY_BUFFER, grgVboPyramidNormal);
...
void Uninitialize()
{
	...
	if (grgVboPyramidPosition)
	{
		glDeleteBuffers(1, &grgVboPyramidPosition);
		grgVboPyramidPosition = 0;
	}
	if (grgVboPyramidNormal)
	{
		glDeleteBuffers(1, &grgVboPyramidNormal);
		grgVboPyramidNormal = 0;
	}
