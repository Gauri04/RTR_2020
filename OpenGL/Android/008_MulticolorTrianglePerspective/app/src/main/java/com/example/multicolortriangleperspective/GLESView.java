package com.example.multicolortriangleperspective;
	...
	OnGestureListener, OnDoubleTapListener
{
	...
	private int[] grvboPosition = new int[1];
	...
	private void initialize(GL10 gl)
	{
		...
		GLES32.glGenBuffers(1, grvboPosition, 0);
		GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, grvboPosition[0]);
	...
	void uninitialize()
	{
		...
		if(grvboPosition[0] != 0)
		{
			GLES32.glDeleteBuffers(1, grvboPosition, 0);
			grvboPosition[0] = 0;
		}
		
		if(grvboColor[0] != 0)
		{
			GLES32.glDeleteBuffers(1, grvboColor, 0);
			grvboColor[0] = 0;
		}
