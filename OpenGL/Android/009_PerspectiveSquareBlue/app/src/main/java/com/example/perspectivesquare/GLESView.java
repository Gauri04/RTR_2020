package com.example.perspectivesquare;
	...
	OnGestureListener, OnDoubleTapListener
{
	...
	private void initialize(GL10 gl)
	{
		...
		// position
		ByteBuffer grbyteBuffer = ByteBuffer.allocateDirect(grsquareVertices.length 
			* 4);
		...
		// color
		GLES32.glVertexAttrib3f(GLESMacros.GR_ATTRIBUTE_COLOR, 0.0f, 0.0f, 1.0f);
