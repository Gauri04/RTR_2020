...
void Display(void)
{
	...
	glColor3f(1.0f, 0.0f, 0.0f);
	glBegin(GL_LINES);
		// line from left top to right bottom of rectangle
		glVertex3f(-1.2f, 1.0f, 0.0f);		
		glVertex3f(1.2f, -1.0f, 0.0f);
		// line from right top to left bottom
		glVertex3f(1.2f, 1.0f, 0.0f);
		glVertex3f(-1.2f, -1.0f, 0.0f);
		// line from middle top to middle left
		glVertex3f(0.0f, 1.0f, 0.0f);
		glVertex3f(-1.2f, 0.0f, 0.0f);
		// line from middle left to middle bottom
		glVertex3f(-1.2f, 0.0f, 0.0f);
		glVertex3f(0.0f, -1.0f, 0.0f);
		// line from middle bottom to middle right
		glVertex3f(0.0f, -1.0f, 0.0f);
		glVertex3f(1.2f, 0.0f, 0.0f);
		// line from middle right to middle top
		glVertex3f(1.2f, 0.0f, 0.0f);
		glVertex3f(0.0f, 1.0f, 0.0f);
	glEnd();
	SwapBuffers(grghdc);
