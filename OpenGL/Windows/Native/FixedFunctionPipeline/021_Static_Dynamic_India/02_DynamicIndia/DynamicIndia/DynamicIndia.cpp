		...
		if (grbI2Moved == true)
		{
			if (grColorDSaffronRed <= 1.0f)
			{
				if (grColorDSaffronGreen <= 0.5f)
				{
					...
					grColorDSaffronGreen = grColorDSaffronGreen + 0.0005f;
				}
				grColorDSaffronRed = grColorDSaffronRed + 0.0010f;
			}

			if (grColorDWhite <= 1.0f)
			{
				grColorDWhite = grColorDWhite + 0.0010f;
			}
			...
			if (grColorDGreenGreen <= 0.53f)
			{
				if (grColorDGreenRed <= 0.07f)
				{
					...
					{
						grColorDGreenBlue = grColorDGreenBlue + 0.000050f;
					}
					grColorDGreenRed = grColorDGreenRed + 0.00010f;
				}
				grColorDGreenGreen = grColorDGreenGreen + 0.00050f;
			}
