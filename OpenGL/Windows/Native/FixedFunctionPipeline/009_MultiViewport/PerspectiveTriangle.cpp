	...
	switch(iMsg)
	{
		...
		case WM_KEYDOWN : 
			switch(wParam)
			{
				...
				case 0x46 :					// F key press
					ToggleFullScreen();
					break;

				case 0x30 :							// 0 key press 
				case VK_NUMPAD0:					// numpad 0 key press
					GetClientRect(hwnd, &rc);
					glViewport(GLsizei(rc.left), GLsizei(rc.top), GLsizei(rc.right), GLsizei(rc.bottom));
					break;
				...
				case VK_NUMPAD5 :
					GetClientRect(hwnd, &rc);
					glViewport(0, 0, (GLsizei(rc.right)) / 2, GLsizei(rc.bottom));
					break;

				case 0x36 : 
				case VK_NUMPAD6 :
					GetClientRect(hwnd, &rc);
					glViewport((GLsizei(rc.right)) / 2, 0, (GLsizei(rc.right)) / 2, GLsizei(rc.bottom));
					break;

				case 0x37 :
				case VK_NUMPAD7 :
					GetClientRect(hwnd, &rc);
					glViewport(0, (GLsizei(rc.bottom)) / 2, GLsizei(rc.right), (GLsizei(rc.bottom)) / 2);
					break;

				case 0x38 :
				case VK_NUMPAD8 :
					GetClientRect(hwnd, &rc);
					glViewport(0, 0, GLsizei(rc.right), (GLsizei(rc.bottom)) / 2);
					break;
