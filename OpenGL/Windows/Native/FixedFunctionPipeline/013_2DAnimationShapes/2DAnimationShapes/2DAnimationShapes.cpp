...
// program specific global variables declaration
GLfloat grfrotate = 0.0f;
...
void Display(void)
{
	...
	glRotatef(grfrotate, 0.0f, 1.0f, 0.0f);
	...
	glLoadIdentity();
	glTranslatef(2.0f, 0.0f, -6.0f);
	glRotatef(grfrotate, 1.0f, 0.0f, 0.0f);
