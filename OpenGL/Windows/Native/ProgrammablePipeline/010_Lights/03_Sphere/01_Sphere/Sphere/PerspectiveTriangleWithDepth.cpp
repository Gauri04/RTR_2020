...
vec4 grgLd = {1.0, 1.0, 1.0, 1.0};
vec4 grgLs = {1.0, 1.0, 1.0, 1.0};
...
void Display(void)
{
	...
	if (grgbLKeyPressed == true)
	{
		...
		glUniform3fv(grgLaUniform, 1, grgLs);
		glUniform3fv(grgLdUniform, 1, grgKd);
		glUniform3fv(grgLaUniform, 1, grgKa);
		glUniform3fv(grgLaUniform, 1, grgKs);
